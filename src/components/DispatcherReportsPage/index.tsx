    ...
    return (
        <div className="space-y-6">
            <div className="flex justify-between items-center">
                <div>
                    <h1 className="text-2xl font-semibold text-neutral-300">Báo cáo & Thống kê Hiệu suất</h1>
            ...
            <Card className="bg-darkCardV1 border-darkBorderV1 shadow-xl">
                <CardContent className="p-4 flex flex-wrap items-end gap-6">
                    <div className="space-y-1.5">
                        <label className="text-xs font-semibold text-neutral-400 uppercase tracking-widest">Chọn tài xế</label>
                    ...
                    <div className="space-y-1.5">
                        <label className="text-xs font-semibold text-neutral-400 uppercase tracking-widest">Từ ngày</label>
                        <DatePicker date={dateFrom} onDateChange={setDateFrom} />
                    </div>

                    <div className="space-y-1.5">
                        <label className="text-xs font-semibold text-neutral-400 uppercase tracking-widest">Đến ngày</label>
                        <DatePicker date={dateTo} onDateChange={setDateTo} />
                    </div>

                    <Button className="bg-primary hover:bg-primary/90 text-black font-semibold flex items-center gap-2 px-8 h-11 rounded-xl shadow-lg shadow-primary/10">
                ...
                <div className="space-y-6">
                    {selectedDriver && (
                        <div className="flex items-center gap-4 p-4 bg-primary/5 border border-primary/20 rounded-2xl">
                            <div className="w-12 h-12 rounded-2xl bg-primary/20 flex items-center justify-center text-primary font-semibold text-xl">
                                {selectedDriver.name.charAt(0)}
                            </div>
                            <div>
                                <h2 className="text-xl font-semibold text-neutral-300">{selectedDriver.name}</h2>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                        <Card className="bg-darkCardV1 border-darkBorderV1 hover:border-primary/30 transition-all shadow-lg group">
                            <CardContent className="p-6 flex flex-col items-center gap-2 relative overflow-hidden">
                                ...
                                <p className="text-xs text-neutral-400 font-semibold uppercase tracking-widest">Tổng chuyến gán</p>
                            </CardContent>
                        </Card>
                        ...
                        <Card className="bg-darkCardV1 border-darkBorderV1 hover:border-emerald-500/30 transition-all shadow-lg group">
                            <CardContent className="p-6 flex flex-col items-center gap-2 relative overflow-hidden">
                                ...
                                <p className="text-xs text-neutral-400 font-semibold uppercase tracking-widest">Thu nhập gộp</p>
                            </CardContent>
                        </Card>
                        ...
                        <Card className="bg-darkCardV1 border-darkBorderV1 hover:border-yellow-500/30 transition-all shadow-lg group">
                            <CardContent className="p-6 flex flex-col items-center gap-2 relative overflow-hidden">
                                ...
                                <p className="text-xs text-neutral-400 font-semibold uppercase tracking-widest">Đánh giá sao</p>
                            </CardContent>
                        </Card>
                        ...
                        <Card className="bg-darkCardV1 border-darkBorderV1 hover:border-blue-500/30 transition-all shadow-lg group">
                            <CardContent className="p-6 flex flex-col items-center gap-2 relative overflow-hidden">
                                ...
                                <p className="text-xs text-neutral-400 font-semibold uppercase tracking-widest">Tỷ lệ hoàn thành</p>
                            </CardContent>
                        </Card>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <Card className="bg-darkCardV1 border-darkBorderV1 shadow-lg">
                            ...
                            <CardContent className="pt-6 space-y-4">
                                <div className="flex items-center justify-between p-4 bg-darkBackgroundV1 rounded-xl border border-darkBorderV1">
                                    ...
                                    <span className="text-2xl font-semibold text-green-500">{performance?.completedTrips || 0}</span>
                                </div>
                                <div className="flex items-center justify-between p-4 bg-darkBackgroundV1 rounded-xl border border-darkBorderV1">
                                    <div className="flex items-center gap-3">
                                    ...
                                    <span className="text-2xl font-semibold text-red-500">{performance?.cancelledTrips || 0}</span>
                                </div>
                            </CardContent>
                        </Card>
                        ...
                        <Card className="bg-darkCardV1 border-darkBorderV1 shadow-lg flex flex-col justify-center items-center p-10 text-center">
                            ...
                            <h3 className="text-lg font-semibold text-neutral-300 mb-2">Thông tin phân tích</h3>
