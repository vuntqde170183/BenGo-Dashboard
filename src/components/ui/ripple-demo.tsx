...
export const RippleDemo: React.FC = () => {
  return (
    <div className="p-8 space-y-4 bg-gray-50 rounded-lg">
      <h2 className="text-2xl font-semibold dark:text-neutral-300 mb-4">
        Ripple Effect Demo
      </h2>

      {/* Button with Ripple */}
      <div className="space-y-4">
        <h3 className="text-lg font-semibold dark:text-neutral-300">
        ...
        <div className="bg-gray-800 rounded-lg p-4 space-y-2">
          {["Dashboard", "Users", "Settings", "Reports"].map((item) => (
            <RippleEffect
              ...
              className="block"
            >
              <div className="flex items-center p-3 text-neutral-300 hover:bg-gray-700 rounded-lg cursor-pointer transition-colors">
